...
public class BalanceServiceTest {
    ...
    @Test
    @DisplayName("Тест recalculateBalance")
    @Order(2)
    void recalculateBalanceTest() {
        Assertions.assertEquals(9250, balanceService.recalculateBalance(1));
        Assertions.assertEquals(9250, balanceService.getBalance(1));
        Assertions.assertEquals(9250, bankAccountManager.getBankAccounts(1).getBalance());
    }

    @Test
    @DisplayName("Тест getBalance")
    @Order(3)
    void getBalanceTest() {
        Assertions.assertEquals(bankAccountManager.getBankAccounts(1).getBalance(), balanceService.getBalance(1));
    }
