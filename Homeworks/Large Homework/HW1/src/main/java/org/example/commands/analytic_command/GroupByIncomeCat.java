...
public class GroupByIncomeCat implements ICommand{
    private final Analytics analytics;
    Scanner scan;
    public GroupByIncomeCat(Analytics analytics) {
    ...
    public void execute() {
        try {
            ...
            Map<String, ArrayList<Operation>> res = analytics.groupByIncome(id);
            int ind = 1;
