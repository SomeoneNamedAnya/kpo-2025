...
public class ImportYAMLTest {
    ...
    @Order(2)
    void saveAll() {
        Assertions.assertDoesNotThrow(() -> categoryManager.importDate(new YamlImporter(), "category.yaml"));
        Assertions.assertDoesNotThrow(() -> operationManager.importDate(new YamlImporter(), "operation.yaml"));
        Assertions.assertDoesNotThrow(() -> bankAccountManager.importDate(new YamlImporter(), "bankaccount.yaml"));
